	  ...
	  var visitor = {
	    TaggedTemplateExpression: function TaggedTemplateExpression(path, state) {
	      ...
	      if (quasi && tagName) {
	        ...
	        !_schema ?  true ? __webpack_require__(4)(false, 'babel-plugin-relay: Missing schema option. ' + 'Check your .babelrc file or wherever you configure your Babel ' + 'plugins to ensure the "relay" plugin has a "schema" option.\n' + 'https://facebook.github.io/relay/docs/babel-plugin-relay.html#additional-options') : require('./invariant')(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function invariant(condition, format) {
	  if (!condition) {
	    ...
	    throw new Error(__webpack_require__(3).format.apply(__webpack_require__(3), [format].concat(args)));
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayQLNode = function () {
	  ...
	  RelayQLNode.prototype.getType = function getType() {
	     true ?  true ? __webpack_require__(4)(false, 'Missing Implementation') : require('./invariant')(false) : void 0;
	  };

	  RelayQLNode.prototype.getField = function getField(fieldName) {
	    return __webpack_require__(7)(this.getFields(), function (field) {
	  ...
	  RelayQLNode.prototype.getSelections = function getSelections() {
	    ...
	    return this.ast.selectionSet.selections.map(function (selection) {
	      if (selection.kind === 'Field') {
	        ...
	        throw new (__webpack_require__(2))(__webpack_require__(3).format('Unexpected selection kind: %s', selection.kind), _this.getLocation());
	      }
	    });
	  };
	...
	var RelayQLFragment = function (_RelayQLDefinition) {
	  ...
	  function RelayQLFragment(context, ast, parentType) {
	    ...
	    var relayDirective = __webpack_require__(7)(ast.directives || [], function (directive) {
	  ...
	  RelayQLFragment.prototype.getType = function getType() {
	    ...
	    if (type) {
	      ...
	      if (!this.parentType) {
	        throw new (__webpack_require__(2))('Cannot get type of typeless inline fragment without parent type.', this.getLocation());
	      }
	      return this.parentType;
	    } else {
	      throw new (__webpack_require__(2))(__webpack_require__(3).format('Unexpected fragment kind: %s', this.ast.kind), this.getLocation());
	    }
	  };
	...
	var RelayQLField = function (_RelayQLNode2) {
	  ...
	  function RelayQLField(context, ast, parentType) {
	    ...
	    if (!fieldDef) {
	      throw new (__webpack_require__(2))(__webpack_require__(3).format('You supplied a field named `%s` on type `%s`, but no such field ' + 'exists on that type.', fieldName, parentType.getName({ modifiers: false })), _this8.getLocation());
	    }
	  ...
	  RelayQLField.prototype.findArgument = function findArgument(argName) {
	    return __webpack_require__(7)(this.getArguments(), function (arg) {
	      return arg.getName() === argName;
	    });
	  };
	  ...
	  RelayQLField.prototype.getArguments = function getArguments() {
	    ...
	    return (this.ast.arguments || []).map(function (arg) {
	      ...
	      if (!argType) {
	        throw new (__webpack_require__(2))(__webpack_require__(3).format('You supplied an argument named `%s` on field `%s`, but no such ' + 'argument exists on that field.', argName, _this9.getName()), _this9.getLocation());
	      }
	...
	var RelayQLFragmentSpread = function (_RelayQLNode3) {
	  ...
	  RelayQLFragmentSpread.prototype.getSelections = function getSelections() {
	    throw new (__webpack_require__(2))('Cannot get selection of a fragment spread.', this.getLocation());
	  };
	...
	var RelayQLDirective = function () {
	  function RelayQLDirective(context, ast) {
	    ...
	    var schemaDirective = directiveName === __webpack_require__(9).GraphQLRelayDirective.name ? __webpack_require__(9).GraphQLRelayDirective : context.schema.getDirective(directiveName);
	    if (!schemaDirective) {
	      throw new (__webpack_require__(2))(__webpack_require__(3).format('You supplied a directive named `%s`, but no such directive exists.', directiveName), this.getLocation());
	    }
	  ...
	  RelayQLDirective.prototype.getArguments = function getArguments() {
	    ...
	    return (this.ast.arguments || []).map(function (arg) {
	      ...
	      if (!argType) {
	        throw new (__webpack_require__(2))(__webpack_require__(3).format('You supplied an argument named `%s` on directive `%s`, but no ' + 'such argument exists on that directive.', argName, _this13.getName()), _this13.getLocation());
	      }
	...
	var RelayQLArgument = function () {
	  ...
	  RelayQLArgument.prototype.getVariableName = function getVariableName() {
	    if (this.ast.value.kind !== 'Variable') {
	      throw new (__webpack_require__(2))('Cannot get variable name of an argument value.', this.getLocation());
	    }
	  ...
	  RelayQLArgument.prototype.getValue = function getValue() {
	    ...
	    if (this.isVariable()) {
	      throw new (__webpack_require__(2))('Cannot get value of an argument variable.', this.getLocation());
	    }
	...
	var RelayQLType = function () {
	  ...
	  RelayQLType.prototype.canHaveSubselections = function canHaveSubselections() {
	    return !(this.schemaUnmodifiedType instanceof __webpack_require__(1).GraphQLScalarType || this.schemaUnmodifiedType instanceof __webpack_require__(1).GraphQLEnumType);
	  };
	  ...
	  RelayQLType.prototype.getFieldDefinition = function getFieldDefinition(fieldName, fieldAST) {
	    ...
	    var hasTypeName = type instanceof __webpack_require__(1).GraphQLObjectType || type instanceof __webpack_require__(1).GraphQLInterfaceType || type instanceof __webpack_require__(1).GraphQLUnionType;
	    var hasFields = type instanceof __webpack_require__(1).GraphQLObjectType || type instanceof __webpack_require__(1).GraphQLInterfaceType;

	    var schemaFieldDef = void 0;
	    if (isQueryType && fieldName === __webpack_require__(1).SchemaMetaFieldDef.name) {
	      schemaFieldDef = __webpack_require__(1).SchemaMetaFieldDef;
	    } else if (isQueryType && fieldName === __webpack_require__(1).TypeMetaFieldDef.name) {
	      schemaFieldDef = __webpack_require__(1).TypeMetaFieldDef;
	    } else if (hasTypeName && fieldName === __webpack_require__(1).TypeNameMetaFieldDef.name) {
	      schemaFieldDef = __webpack_require__(1).TypeNameMetaFieldDef;
	    } else if (hasFields) {
	      schemaFieldDef = type.getFields()[fieldName];
	    }

	    // Temporary workaround to support fixme_fat_interface
	    if (!schemaFieldDef && __webpack_require__(1).isAbstractType(type) && fieldAST && fieldAST.directives && fieldAST.directives.some(function (directive) {
	        ...
	        if (possibleField) {
	          ...
	          if (fieldAST && fieldAST.arguments) {
	            var argumentsAllExist = fieldAST.arguments.every(function (argument) {
	              return __webpack_require__(7)(possibleField.args, function (argDef) {
	  ...
	  RelayQLType.prototype.getInterfaces = function getInterfaces() {
	    ...
	    if (this.schemaUnmodifiedType instanceof __webpack_require__(1).GraphQLObjectType) {
	  ...
	  RelayQLType.prototype.getConcreteTypes = function getConcreteTypes() {
	    ...
	    !this.isAbstract() ?  true ? __webpack_require__(4)(false, 'Cannot get concrete types of a concrete type.') : require('./invariant')(false) : void 0;
	  ...
	  RelayQLType.prototype.getIdentifyingFieldDefinition = function getIdentifyingFieldDefinition() {
	    if (this.alwaysImplements('Node')) {
	      return this.getFieldDefinition(__webpack_require__(6).ID);
	    }
	    return null;
	  };

	  RelayQLType.prototype.isAbstract = function isAbstract() {
	    return __webpack_require__(1).isAbstractType(this.schemaUnmodifiedType);
	  };
	...
	var RelayQLFieldDefinition = function () {
	  ...
	  RelayQLFieldDefinition.prototype.getArgument = function getArgument(argName) {
	    var schemaArg = __webpack_require__(7)(this.schemaFieldDef.args, function (arg) {
	      return arg.name === argName;
	    });
	    !schemaArg ?  true ? __webpack_require__(4)(false, 'You tried to get an argument named `%s` on field `%s`, but no such ' + 'argument exists on that field.', argName, this.getName()) : require('./invariant')(false) : void 0;
	...
	var RelayQLArgumentType = function () {
	  ...
	  RelayQLArgumentType.prototype.ofType = function ofType() {
	    !(this.isList() || this.isNonNull()) ?  true ? __webpack_require__(4)(false, 'Can only get type of list or non-null type.') : require('./invariant')(false) : void 0;
	  ...
	  RelayQLArgumentType.prototype.isCustomScalar = function isCustomScalar() {
	    return this.isScalar() && !(this.schemaUnmodifiedArgType === __webpack_require__(1).GraphQLBoolean || this.schemaUnmodifiedArgType === __webpack_require__(1).GraphQLFloat || this.schemaUnmodifiedArgType === __webpack_require__(1).GraphQLID || this.schemaUnmodifiedArgType === __webpack_require__(1).GraphQLInt || this.schemaUnmodifiedArgType === __webpack_require__(1).GraphQLString);
	  };

	  RelayQLArgumentType.prototype.isBoolean = function isBoolean() {
	    return this.schemaUnmodifiedArgType === __webpack_require__(1).GraphQLBoolean;
	  };

	  RelayQLArgumentType.prototype.isEnum = function isEnum() {
	    return this.schemaUnmodifiedArgType instanceof __webpack_require__(1).GraphQLEnumType;
	  };

	  RelayQLArgumentType.prototype.isID = function isID() {
	    return this.schemaUnmodifiedArgType === __webpack_require__(1).GraphQLID;
	  };
	  ...
	  RelayQLArgumentType.prototype.isNumber = function isNumber() {
	    return this.schemaUnmodifiedArgType === __webpack_require__(1).GraphQLFloat || this.schemaUnmodifiedArgType === __webpack_require__(1).GraphQLInt;
	  };

	  RelayQLArgumentType.prototype.isObject = function isObject() {
	    return this.schemaUnmodifiedArgType instanceof __webpack_require__(1).GraphQLInputObjectType;
	  };

	  RelayQLArgumentType.prototype.isScalar = function isScalar() {
	    return this.schemaUnmodifiedArgType instanceof __webpack_require__(1).GraphQLScalarType;
	  };

	  RelayQLArgumentType.prototype.isString = function isString() {
	    return this.schemaUnmodifiedArgType === __webpack_require__(1).GraphQLString;
	  };
	...
	function stripMarkerTypes(schemaModifiedType) {
	  ...
	  while (true) {
	    if (schemaUnmodifiedType instanceof __webpack_require__(1).GraphQLList) {
	      isListType = true;
	    } else if (schemaUnmodifiedType instanceof __webpack_require__(1).GraphQLNonNull) {
	      isNonNullType = true;
	    } else {
	      break;
	    }
	...
	function getLiteralValue(value) {
	  switch (value.kind) {
	    ...
	    case 'ObjectValue':
	      ...
	      return object;
	    case 'Variable':
	      throw new (__webpack_require__(2))(__webpack_require__(3).format('Unexpected nested variable `%s`; variables are supported as top-' + 'level arguments - `node(id: $id)` - or directly within lists - ' + '`nodes(ids: [$id])`.', value.name.value), value.loc);
	    default:
	      throw new (__webpack_require__(2))(__webpack_require__(3).format('Unexpected value kind: %s', value.kind), value.loc);
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GraphQLRelayDirective = __webpack_require__(1).buildSchema(SCHEMA_EXTENSION + '\ntype Query { x: String }').getDirective('relay');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getSchema(schemaProvider, fileOptions) {
	  ...
	  if (introspection.__schema) {
	    return __webpack_require__(1).buildClientSchema(introspection);
	  } else if (introspection.data && introspection.data.__schema) {
	    return __webpack_require__(1).buildClientSchema(introspection.data);
	  } else if (introspection.kind && introspection.kind === 'Document') {
	    return __webpack_require__(1).buildASTSchema(introspection, { assumeValid: true });
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _toConsumableArray3 = _interopRequireDefault(__webpack_require__(14));
	...
	module.exports = function (t, options) {
	  ...
	  var RelayQLPrinter = function () {
	    ...
	    RelayQLPrinter.prototype.print = function print(definition, substitutions) {
	      ...
	      if (definition instanceof __webpack_require__(5).RelayQLQuery) {
	        printedDocument = this.printQuery(definition, enableValidation);
	      } else if (definition instanceof __webpack_require__(5).RelayQLFragment) {
	        printedDocument = this.printFragment(definition);
	      } else if (definition instanceof __webpack_require__(5).RelayQLMutation) {
	        printedDocument = this.printMutation(definition, enableValidation);
	      } else if (definition instanceof __webpack_require__(5).RelayQLSubscription) {
	        printedDocument = this.printSubscription(definition, enableValidation);
	      } else {
	        throw new (__webpack_require__(2))(__webpack_require__(3).format('Unsupported definition: %s', definition), definition.getLocation());
	      }
	    ...
	    RelayQLPrinter.prototype.printQuery = function printQuery(query, enableValidation) {
	      ...
	      if (rootFields.length !== 1 && enableValidation) {
	        throw new (__webpack_require__(2))(__webpack_require__(3).format('There are %d fields supplied to the query named `%s`, but queries ' + 'must have exactly one field.', rootFields.length, query.getName()), query.getLocation());
	      }
	      ...
	      if (rootFieldArgs.length > 1) {
	        throw new (__webpack_require__(2))(__webpack_require__(3).format('Invalid root field `%s`; Relay only supports root fields with zero ' + 'or one argument.', rootField.getName()), query.getLocation());
	      }
	    ...
	    RelayQLPrinter.prototype.printFragment = function printFragment(fragment) {
	      ...
	      if (fragmentType.hasField(__webpack_require__(6).ID)) {
	        requisiteFields[__webpack_require__(6).ID] = true;
	      ...
	      var selectVariables = relayDirective && __webpack_require__(7)(relayDirective.getArguments(), function (arg) {
	      ...
	      if (selectVariables) {
	        ...
	        if (!Array.isArray(selectVariablesValue)) {
	          throw new (__webpack_require__(2))('The variables argument to the @relay directive should be an array ' + 'of strings.', fragment.getLocation());
	        }
	    ...
	    RelayQLPrinter.prototype.printMutation = function printMutation(mutation, enableValidation) {
	      ...
	      if (rootFields.length !== 1 && enableValidation) {
	        throw new (__webpack_require__(2))(__webpack_require__(3).format('There are %d fields supplied to the mutation named `%s`, but ' + 'mutations must have exactly one field.', rootFields.length, mutation.getName()), mutation.getLocation());
	      }
	      var rootField = rootFields[0];
	      var rootFieldType = rootField.getType();
	    ...
	    RelayQLPrinter.prototype.printSubscription = function printSubscription(subscription, enableValidation) {
	      ...
	      if (rootFields.length !== 1 && enableValidation) {
	        throw new (__webpack_require__(2))(__webpack_require__(3).format('There are %d fields supplied to the subscription named `%s`, but ' + 'subscriptions must have exactly one field.', rootFields.length, subscription.getName()), subscription.getLocation());
	      }
	      var rootField = rootFields[0];
	      var rootFieldType = rootField.getType();
	      validateMutationField(rootField);
	    ...
	    RelayQLPrinter.prototype.printSelections = function printSelections(parent, requisiteFields, extraFragments) {
	      ...
	      parent.getSelections().forEach(function (selection) {
	        if (selection instanceof __webpack_require__(5).RelayQLFragmentSpread) {
	          // Assume that all spreads exist via template substitution.
	          if (selection.getDirectives().length !== 0) {
	            throw new (__webpack_require__(2))('Directives are not yet supported for `${fragment}`-style fragment ' + 'references.', selection.getLocation());
	          }
	          printedFragments.push(_this2.printFragmentReference(selection));
	          didPrintFragmentReference = true;
	        } else if (selection instanceof __webpack_require__(5).RelayQLInlineFragment) {
	          printedFragments.push(_this2.printFragment(selection.getFragment()));
	        } else if (selection instanceof __webpack_require__(5).RelayQLField) {
	          fields.push(selection);
	        } else {
	          throw new (__webpack_require__(2))(__webpack_require__(3).format('Unsupported selection type `%s`.', selection), selection.getLocation());
	        }
	      });
	      if (extraFragments) {
	    ...
	    RelayQLPrinter.prototype.printField = function printField(field, parent, requisiteSiblings, generatedSiblings) {
	      ...
	      var requisiteFields = {};
	      var idFragment = void 0;
	      if (fieldType.hasField(__webpack_require__(6).ID)) {
	        requisiteFields[__webpack_require__(6).ID] = true;
	      ...
	      if (fieldType.alwaysImplements('Node')) {
	        ...
	        metadata.inferredPrimaryKey = __webpack_require__(6).ID;
	      }
	    ...
	    maybeMetadata) {
	      ...
	      if (relayDirective) {
	        relayDirective.getArguments().forEach(function (arg) {
	          if (arg.isVariable()) {
	            throw new (__webpack_require__(2))(__webpack_require__(3).format('You supplied `$%s` as the `%s` argument to the `@relay` ' + 'directive, but `@relay` require scalar argument values.', arg.getVariableName(), arg.getName()), node.getLocation());
	          }
	  ...
	  function shouldGenerateIdFragment(node) {
	    return node.getType().mayImplement('Node') && !node.getSelections().some(function (selection) {
	      return selection instanceof __webpack_require__(5).RelayQLInlineFragment && selection.getFragment().getType().getName({ modifiers: false }) === 'Node';
	    });
	  }
	  ...
	  function validateField(field, parentType) {
	    if (field.getName() === 'node') {
	      ...
	      if (!parentType.isQueryType() && argNames.length === 1 && argNames[0] === __webpack_require__(6).ID) {
	        throw new (__webpack_require__(2))(__webpack_require__(3).format('You defined a `node(%s: %s)` field on type `%s`, but Relay requires ' + 'the `node` field to be defined on the root type. See the Object ' + 'Identification Guide: \n' + 'http://facebook.github.io/relay/docs/graphql-object-identification.html', __webpack_require__(6).ID, argNames[0] && argTypes[argNames[0]].getName({ modifiers: true }), parentType.getName({ modifiers: false })), field.getLocation());
	      }
	    }
	  }
	  ...
	  function validateConnectionField(field) {
	    ...
	    if (!condition) {
	      throw new (__webpack_require__(2))(__webpack_require__(3).format('Connection arguments `%s(first: <count>, last: <count>)` are ' + 'not supported unless both are variables. Use `(first: <count>)`, ' + '`(last: <count>)`, or `(first: $<var>, last: $<var>)`.', field.getName()), field.getLocation());
	    }
	    condition = !first || !before || first.isVariable() && before.isVariable();
	    if (!condition) {
	      throw new (__webpack_require__(2))(__webpack_require__(3).format('Connection arguments `%s(before: <cursor>, first: <count>)` are ' + 'not supported unless both are variables. Use `(first: <count>)`, ' + '`(after: <cursor>, first: <count>)`, `(before: <cursor>, last: <count>)`, ' + 'or `(before: $<var>, first: $<var>)`.', field.getName()), field.getLocation());
	    }
	    condition = !last || !after || last.isVariable() && after.isVariable();
	    if (!condition) {
	      throw new (__webpack_require__(2))(__webpack_require__(3).format('Connection arguments `%s(after: <cursor>, last: <count>)` are ' + 'not supported unless both are variables. Use `(last: <count>)`, ' + '`(before: <cursor>, last: <count>)`, `(after: <cursor>, first: <count>)`, ' + 'or `(after: $<var>, last: $<var>)`.', field.getName()), field.getLocation());
	    }
	    ...
	    forEachRecursiveField(field, function (subfield) {
	      if (subfield.getName() === FIELDS.edges || subfield.getName() === FIELDS.pageInfo) {
	        ...
	        if (!hasCondition) {
	          throw new (__webpack_require__(2))(__webpack_require__(3).format('You supplied the `%s` field on a connection named `%s`, but you did ' + 'not supply an argument necessary for Relay to handle the connection. ' + 'Please specify a limit argument like `first`, or `last` or ' + 'fetch a specific item with a `find` argument.', subfield.getName(), field.getName()), field.getLocation());
	        }
	      } else {
	        ...
	        if (isNodesLikeField) {
	          throw new (__webpack_require__(2))(__webpack_require__(3).format('You supplied a field named `%s` on a connection named `%s`, but ' + 'pagination is not supported on connections without using `%s`. ' + 'Use `%s{%s{%s{...}}}` instead.', subfield.getName(), field.getName(), FIELDS.edges, field.getName(), FIELDS.edges, FIELDS.node), field.getLocation());
	        }
	      }
	    });
	  }
	  ...
	  function validateMutationField(rootField) {
	    ...
	    if (declaredArgNames.length !== 1) {
	      throw new (__webpack_require__(2))(__webpack_require__(3).format('Your schema defines a mutation field `%s` that takes %d arguments, ' + 'but mutation fields must have exactly one argument named `%s`.', rootField.getName(), declaredArgNames.length, INPUT_ARGUMENT_NAME), rootField.getLocation());
	    }

	    if (declaredArgNames[0] !== INPUT_ARGUMENT_NAME) {
	      throw new (__webpack_require__(2))(__webpack_require__(3).format('Your schema defines a mutation field `%s` that takes an argument ' + 'named `%s`, but mutation fields must have exactly one argument ' + 'named `%s`.', rootField.getName(), declaredArgNames[0], INPUT_ARGUMENT_NAME), rootField.getLocation());
	    }

	    var rootFieldArgs = rootField.getArguments();
	    if (rootFieldArgs.length > 1) {
	      throw new (__webpack_require__(2))(__webpack_require__(3).format('There are %d arguments supplied to the mutation field named `%s`, ' + 'but mutation fields must have exactly one `%s` argument.', rootFieldArgs.length, rootField.getName(), INPUT_ARGUMENT_NAME), rootField.getLocation());
	    }
	  }
	  ...
	  var forEachRecursiveField = function forEachRecursiveField(parentSelection, callback) {
	    parentSelection.getSelections().forEach(function (selection) {
	      if (selection instanceof __webpack_require__(5).RelayQLField) {
	        callback(selection);
	      } else if (selection instanceof __webpack_require__(5).RelayQLInlineFragment) {
	  ...
	  function findRelayDirective(node) {
	    return __webpack_require__(7)(node.getDirectives(), function (directive) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayQLTransformer = function () {
	  ...
	  RelayQLTransformer.prototype.processTemplateLiteral = function processTemplateLiteral(node, documentName) {
	    ...
	    node.quasis.forEach(function (element, ii) {
	      ...
	      if (!element.tail) {
	        ...
	        if (/:\s*$/.test(chunk)) {
	          !_this.options.substituteVariables ?  true ? __webpack_require__(4)(false, 'You supplied a GraphQL document named `%s` that uses template ' + 'substitution for an argument value, but variable substitution ' + 'has not been enabled.', documentName) : require('./invariant')(false) : void 0;
	          chunks.push('$' + name);
	  ...
	  RelayQLTransformer.prototype.processTemplateText = function processTemplateText(templateText, _ref) {
	    ...
	    !matches ?  true ? __webpack_require__(4)(false, 'You supplied a GraphQL document named `%s` with invalid syntax. It ' + 'must start with `fragment`, `mutation`, `query`, or `subscription`.', documentName) : require('./invariant')(false) : void 0;
	    var type = matches[1];
	  ...
	  RelayQLTransformer.prototype.processDocumentText = function processDocumentText(documentText, _ref2) {
	    ...
	    var document = __webpack_require__(1).parse(new (__webpack_require__(1).Source)(documentText, documentName));
	    var validationErrors = enableValidation ? this.validateDocument(document, documentName) : null;
	    if (validationErrors) {
	      var error = new Error(__webpack_require__(3).format('You supplied a GraphQL document named `%s` with validation errors.', documentName));
	    ...
	    if (definition.kind === 'FragmentDefinition') {
	      return new (__webpack_require__(5).RelayQLFragment)(context, definition);
	    } else if (definition.kind === 'OperationDefinition') {
	      if (definition.operation === 'mutation') {
	        return new (__webpack_require__(5).RelayQLMutation)(context, definition);
	      } else if (definition.operation === 'query') {
	        return new (__webpack_require__(5).RelayQLQuery)(context, definition);
	      } else if (definition.operation === 'subscription') {
	        return new (__webpack_require__(5).RelayQLSubscription)(context, definition);
	      } else {
	         true ?  true ? __webpack_require__(4)(false, 'Unsupported operation: %s', definition.operation) : require('./invariant')(false) : void 0;
	      }
	    } else {
	       true ?  true ? __webpack_require__(4)(false, 'Unsupported definition kind: %s', definition.kind) : require('./invariant')(false) : void 0;
	    }
	  };

	  RelayQLTransformer.prototype.validateDocument = function validateDocument(document, documentName) {
	    !(document.definitions.length === 1) ?  true ? __webpack_require__(4)(false, 'You supplied a GraphQL document named `%s` with %d definitions, but ' + 'it must have exactly one definition.', documentName, document.definitions.length) : require('./invariant')(false) : void 0;
	    ...
	    if (validator) {
	      ...
	      var rules = [__webpack_require__(1).FieldsOnCorrectTypeRule, __webpack_require__(1).FragmentsOnCompositeTypesRule, __webpack_require__(1).KnownArgumentNamesRule, __webpack_require__(1).KnownTypeNamesRule, __webpack_require__(1).PossibleFragmentSpreadsRule, __webpack_require__(1).ValuesOfCorrectTypeRule, __webpack_require__(1).VariablesInAllowedPositionRule];
	      validationErrors = __webpack_require__(1).validate(this.schema, document, rules);
	    }

	    if (validationErrors && validationErrors.length > 0) {
	      return validationErrors.map(__webpack_require__(1).formatError);
	    }
	    return null;
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	  ...
	  if (mainDefinition.kind === 'FragmentDefinition') {
	    ...
	    try {
	      for (var _iterator = ast.definitions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        ...
	        var _getFragmentNameParts = __webpack_require__(10)(definition.name.value),
	...
	function createAST(t, state, path, graphqlDefinition) {
	  ...
	  var modernNode = __webpack_require__(22)(t, graphqlDefinition, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createClassicAST(t, definition) {
	  ...
	  var visitors = {
	    ...
	    FragmentSpread: function FragmentSpread(node) {
	      ...
	      if (directives.length === 0) {
	        ...
	        !(directives.length === 1) ?  true ? __webpack_require__(4)(false, 'BabelPluginRelay: Cannot use both `@arguments` and `@relay(mask: false)` on the ' + 'same fragment spread when in compat mode.') : require('./invariant')(false) : void 0;
	        switch (directive.name.value) {
	          ...
	          case 'relay':
	            ...
	            // $FlowFixMe graphql 0.12.2
	            relayArguments[0].name.value === 'mask') ?  true ? __webpack_require__(4)(false, 'BabelPluginRelay: Expected `@relay` directive to only have `mask` argument in ' + 'compat mode, but get %s',
	            // $FlowFixMe graphql 0.12.2
	      ...
	      !substitutionName ?  true ? __webpack_require__(4)(false, 'BabelPluginRelay: Expected `substitutionName` to be non-null') : require('./invariant')(false) : void 0;
	  ...
	  var classicAST = __webpack_require__(1).visit(definition, visitors);
	...
	function getSchemaOption(state) {
	  ...
	  !schema ?  true ? __webpack_require__(4)(false, 'babel-plugin-relay: Missing schema option. ' + 'Check your .babelrc file or wherever you configure your Babel ' + 'plugins to ensure the "relay" plugin has a "schema" option.\n' + 'https://facebook.github.io/relay/docs/babel-plugin-relay.html#additional-options') : require('./invariant')(false) : void 0;
	  return schema;
	}
	...
	function createRelayQLTemplate(t, path, node, state) {
	  ...
	  var _getFragmentNameParts = __webpack_require__(10)(node.name.value),
	      documentName = _getFragmentNameParts[0],
	      propName = _getFragmentNameParts[1];

	  var text = __webpack_require__(1).print(node);
	...
	function createSubstitutionsForFragmentSpreads(t, path, fragments) {
	  return Object.keys(fragments).map(function (varName) {
	    ...
	    var _getFragmentNameParts2 = __webpack_require__(10)(fragment.name),
	        module = _getFragmentNameParts2[0],
	        propName = _getFragmentNameParts2[1];

	    if (!fragment.isMasked) {
	      !(path.scope.hasBinding(module) || path.scope.hasBinding(propName)) ?  true ? __webpack_require__(4)(false, 'BabelPluginRelay: Please make sure module \'' + module + '\' is imported and not renamed or the\n        fragment \'' + fragment.name + '\' is defined and bound to local variable \'' + propName + '\'. ') : require('./invariant')(false) : void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createModernNode(t, graphqlDefinition, options) {
	  ...
	  var hash = __webpack_require__(30).createHash('md5').update(__webpack_require__(1).print(graphqlDefinition), 'utf8').digest('hex');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createTransformError(error) {
	  if (error instanceof __webpack_require__(2)) {
	  ...
	  return __webpack_require__(3).format('Relay Transform Error: %s\n\n%s', error.message, error.stack);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getDocumentName(path, state) {
	  ...
	  if (!documentName) {
	    ...
	    var basename = state.file && __webpack_require__(16).basename(state.file.opts.filename);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getSchemaIntrospection(schemaPath, basePath) {
	  try {
	    ...
	    if (!__webpack_require__(15).existsSync(fullSchemaPath) && basePath) {
	      fullSchemaPath = __webpack_require__(16).join(basePath, schemaPath);
	    }
	    var source = __webpack_require__(15).readFileSync(fullSchemaPath, 'utf8');
	    if (source[0] === '{') {
	      return JSON.parse(source);
	    }
	    return __webpack_require__(1).parse(__webpack_require__(9).SCHEMA_EXTENSION + '\n' + source);
	  } catch (error) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getValidGraphQLTag(path) {
	  ...
	  var ast = __webpack_require__(1).parse(text);
